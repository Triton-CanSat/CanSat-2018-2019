...
#if !(defined OV5642_MINI_5MP_PLUS || defined OV5642_MINI_5MP_BIT_ROTATION_FIXED|| defined OV2640_MINI_2MP_PLUS || defined OV2640_MINI_2MP|| defined OV3640_MINI_3MP)
...
#define HEIGHT_1 0xE0
#define HEIGHT_2 0x01 
//#define FPS 0x0F // 15 FPS. Placeholder: will be overwritten at runtime based upon real FPS attained
#define FPS 0x1E  //30 fps
#define TOTAL_FRAMES 100	// Number of frames to be recorded. If < 256, easier to recognize in header (for manual hex debug)
...
#elif defined (OV3640_MINI_3MP)
  myCAM.OV3640_set_JPEG_size(FRAME_SIZE);
#else
