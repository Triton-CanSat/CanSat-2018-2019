...
// DEFINES
#if !(defined OV5642_MINI_5MP_PLUS || defined OV5642_MINI_5MP)
...
#define WIDTH_1 0x80  //Video width in pixel, hex. Here we set 640: 0x80
#define WIDTH_2 0x02  //for 640
#define HEIGHT_1 0xE0 //480: 0xE0 pixels height
#define HEIGHT_2 0x01 //for 480
#define FPS 0x1E  //30 fps. Placeholder: will be overwritten at runtime based upon real FPS attained
...
{ // We don't enforce FPS: we just record and save frames as fast as possible
  ...
  //Open the new file
  outFile = sd.open("video.txt", FILE_WRITE);
  /*
...
#ifndef DISABLE_SD
  //Initialize SD Card
  while (!sd.begin(chipSelect, SD_SCK_MHZ(10))) {
